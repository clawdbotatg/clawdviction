...
const OnboardPage: NextPage = () => {
  ...
  return (
    <div className="flex flex-col pt-6 px-5 max-w-2xl mx-auto w-full bg-base-100/60 backdrop-blur-sm rounded-2xl my-4">
      {/* Header */}
      <div className="mb-6">
      ...
      {/* Nav */}
      <div className="mt-4 pt-3 pb-4 border-t border-base-300 flex items-center justify-between gap-3">
